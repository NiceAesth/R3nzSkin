...
class Memory {
 ...
 private:
  ...
  std::vector<offset_signature> sigs{
    ...
    {{"48 8B 0D ? ? ? ? 48 69 D0 ? ? 00 00 48 8B 05"}, true, false, true, 0, &offsets::global::ChampionManager},
    ...
    {{"48 8B 0D ? ? ? ? 48 8B DA 48 8B 52 30"}, true, false, true, 0, &offsets::global::ManagerTemplate_AITurret_},
    {{"48 8B 0D ? ? ? ? FF 15 ? ? ? ? 48 8B 05 ? ? ? ?"}, true, false, true, 0, &offsets::global::Riot__g_window},
    {{"48 8D 8B ? ? ? ? 48 89 44 24 ? C7 44 24"}, false, true, false, 0, &offsets::AIBaseCommon::CharacterDataStack},
    {{"40 38 BB ? ? 00 00 0F 85 ? ? 00 00 66 C7 83 ? ? ? ? ? ? 0F 31 48 C1 E2 20 4C 8D 83 ? ? 00 00 48 0B C2 44 8B CF "
      "48 89 44 24 ? 8B D7 48 63 C2"},
     false,
     true,
     false,
     0,
    ...
    {{"48 8D BB ? ? ? ? C6 83 ? ? ? ? ? 0F 84"}, false, true, false, 0, &offsets::MaterialRegistry::SwapChain},
    ...
    {{"E8 ? ? ? ? 4C 3B F8 0F 94 C0"}, true, false, false, 0, &offsets::functions::GetGoldRedirectTarget}};
};
