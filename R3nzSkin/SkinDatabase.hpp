  ...
  std::vector<jungle_mob_skin_info> jungle_mobs_skins{
    {"Baron",
     ...
     {"Baron", "Snowdown Baron", "Championship Baron", "Lunar Revel Baron", "MSI Baron", "Odyssey Baron",
      "Championship Birthday Baron", "Ruined King Baron"}},
    {"Blue", {FNV("SRU_Blue")}, {"Blue", "Dark Blue", "Pool Party Blue", "Ruined King Blue"}},
    {"Red", {FNV("SRU_Red")}, {"Red", "Pool Party Red", "Ruined King Red"}},
    {"Scuttle",
     {FNV("Sru_Crab")},
